...
public class CodeGenerator 
{
	...
	/**
	 * constructor 
	 * @param synatx  tree (program node)
	 */
	public CodeGenerator(ProgramNode progNode, SymbolTable symTab) 
	{
	...
	private void codeOperation(OperationNode opNode, String reg) 
	{
		...
		else if (opType == TokenType.LESSOREQUAL)
			asmCode += "bgt   " + regL + ",   " + regR + ",   ";
		else if (opType == TokenType.GREATEROREQUAL)
